...
const T = {
  es: {
    ...
    apiKeyPh: "Pega aquí tu API key...",
    apiKeyHint: "Tu agente corre con tu propia llave del proveedor de IA que uses, así tú controlas tu consumo. Muchos ofrecen una capa gratis para empezar. Se guarda oculta: solo la usa el servidor para ejecutar tu agente.",
  ...
  en: {
    ...
    apiKeyHint: "Your agent runs on your own key from whatever AI provider you use, so you control your usage. Many offer a free tier to start. It's stored hidden: only the server uses it to run your agent.",
